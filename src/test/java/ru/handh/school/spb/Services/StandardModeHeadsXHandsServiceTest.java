    ...
    void createCreature() {
        ...
        for (Creature creature: creatures) {
            ...
            assertTrue(attack >= 1 && attack <= 30,
                            "Значение для х-ки \"Атака\" сгенерировано в не разрешенном диапазоне: [1; 30].");
            assertTrue(defence >= 1 && defence <= 30,
                            "Значение для х-ки \"Защита\" сгенерировано в не разрешенном диапазоне: [1; 30].");
            assertTrue(health >= 1 && health <= 100,
                            "Значение для х-ки \"Здоровье\" сгенерировано в не разрешенном диапазоне: [1; 100].");
            assertTrue(damage > 5 && damage < 15,
                            "Значение для х-ки \"Урон\" сгенерировано в не разрешенном диапазоне: (5; 15).");
